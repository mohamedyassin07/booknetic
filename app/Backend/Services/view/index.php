...
<link rel="stylesheet" type="text/css" href="<?php print Helper::assets('css/services.css', 'Services')?>" />
...
<script type="application/javascript" src="<?php print Helper::assets('js/services.js', 'Services')?>"></script>
...
<div class="m_header clearfix">
	...
	<div class="m_head_actions float-right">
		...
		<a href="?page=<?php print Helper::getSlugName() ?>&module=services&view=list" class="btn btn-lg btn-primary float-left" >LIST VIEW</a>
		...
		<ul>
			<li data-type="root" data-id="0">
				<div class="node_details dashed-border">
					<span class="node_name"><?php print bkntc__('Categories')?></span>
					<span class="add_new_node"></span>
				</div>
				<?php print printTree(0, $parameters['categories'], $parameters['staff'])?>
			</li>
		</ul>
	</div>
...
<div id="select_add_type">
	...
	<div class="add_type_title"><?php print bkntc__('What do you want to create?')?></div>

	<div class="add_type_options">
		<button type="button" class="btn btn-lg btn-default" data-type="category"><?php print bkntc__('CATEGORY')?></button>
		<button type="button" class="btn btn-lg btn-default" data-type="service"><?php print bkntc__('SERVICE')?></button>
	</div>

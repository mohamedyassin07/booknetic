...
<div class="m_header clearfix">
	<div class="m_head_title float-left"><?php print bkntc__('SMS Notifications')?> <span class="badge badge-warning"><?php print (int)(count($parameters['notifications'])/2)?></span></div>
	<div class="m_head_actions float-right">
		...
		<button type="button" class="btn btn-lg btn-outline-secondary float-right" id="send_test_sms_btn"><img src="<?php print Helper::icon('send_test_sms.svg', 'Smsnotifications')?>"> <?php print bkntc__('SEND TEST SMS')?></button>
	</div>
</div>
...
<div class="row m-4">
    <div class="col-xl-12 col-md-12 col-lg-12 pr-md-1">
        <ul class="nav nav-tabs nav-light">
            ...
            <li class="nav-item"><a class="nav-link <?php if ($parameters['tab_id'] == '0' or $parameters['tab_id'] == '') print 'active'?>"  href="?page=<?php print Helper::getSlugName() ?>&module=smsnotifications"><?php print bkntc__('DEFAULT')?></a></li>
            <?php
            ...
            foreach ($parameters['tabs'] as $tab)
            {
                ...
                print '<li class="nav-item">
                            <a class="nav-link '.$active.'" href="?page=' . Helper::getSlugName() . '&module=smsnotifications&tab_id='.(int) $tab['id'].'">'.esc_html($tab['name']).'</a>
			...
			<div class="fs_portlet_content">
				...
				<div class="form-row">
					<div class="form-group col-md-12">
						<label><?php print bkntc__('SMS body')?></label>

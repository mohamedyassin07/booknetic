...
class Ajax extends \BookneticApp\Providers\Ajax
{
	...
	public function send_test_message()
	{
		...
		$this->modalView('send_test_message', [ 'id' => $id ] );
	}
	...
	public function send_message()
	{
		...
		$getNotifyInf = Notification::where('id', $id)->where('type', 'whatsapp')->fetch();
		...
		if( Helper::isSaaSVersion() )
		{
			...
			{
				Helper::response( false, bkntc__('You have reached your allowed maximum WhatsApp message limit. Please upgrade your plan.') );
			}
		}
		...
		{
			Helper::response(false, bkntc__('Please configure WhatsApp settings!'));
		}

 ...
 */
class EanExt extends \Booknetic_Mpdf\Barcode\AbstractBarcode implements \Booknetic_Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $length = 5)
	{
		...
		if ($length == 2) {
			...
			throw new \Booknetic_Mpdf\Barcode\BarcodeException('Invalid EAN barcode value');
		}

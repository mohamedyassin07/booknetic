 ...
 */
class EanUpc extends \Booknetic_Mpdf\Barcode\AbstractBarcode implements \Booknetic_Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $length)
	{
		if (preg_match('/[\D]+/', $code)) {
			throw new \Booknetic_Mpdf\Barcode\BarcodeException('Invalid EAN UPC barcode value');
		}
		...
		if ($upce) {
			...
			if ($invalidUpce) {
				throw new \Booknetic_Mpdf\Barcode\BarcodeException('UPC-A cannot produce a valid UPC-E barcode');
			}
		}

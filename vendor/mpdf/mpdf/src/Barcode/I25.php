 ...
 */
class I25 extends \Booknetic_Mpdf\Barcode\AbstractBarcode implements \Booknetic_Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $printRatio, $checksum)
	{
		...
		for ($i = 0; $i < $clen; $i = ($i + 2)) {
			...
			if ((!isset($chr[$charBar])) or (!isset($chr[$charSpace]))) {
				// invalid character
				throw new \Booknetic_Mpdf\Barcode\BarcodeException('Invalid I25 barcode value');
			}

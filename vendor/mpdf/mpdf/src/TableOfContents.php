...
class TableOfContents
{
	...
	public function __construct(Booknetic_Mpdf $mpdf, SizeConverter $sizeConverter)
	{
		$this->mpdf = $mpdf;
	...
	public function insertTOC()
	{
		 ...
		 * numbers are calculated when the TOC pages are moved into position in the cloned object (see Booknetic_Mpdf::MovePages).

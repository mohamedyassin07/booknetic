...
class Tag
{
	...
	/**
	 * @param \Booknetic_Mpdf\Booknetic_Mpdf $mpdf
	 * @param \Booknetic_Mpdf\Cache $cache
	 * @param \Booknetic_Mpdf\CssManager $cssManager
	 * @param \Booknetic_Mpdf\Form $form
	 * @param \Booknetic_Mpdf\Otl $otl
	 * @param \Booknetic_Mpdf\TableOfContents $tableOfContents
	 * @param \Booknetic_Mpdf\SizeConverter $sizeConverter
	 * @param \Booknetic_Mpdf\Color\ColorConverter $colorConverter
	 * @param \Booknetic_Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \Booknetic_Mpdf\Language\LanguageToFontInterface $languageToFont
	 */

...
class Input extends Tag
{
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if (isset($properties['FONT-SIZE'])) {
			...
			$this->mpdf->SetFontSize($mmsize * Booknetic_Mpdf::SCALE, false);
		}
					...
					if ($w == 0 && $h == 0) {
						...
						if ($info['type'] === 'wmf') {
							...
							if ($info['type'] === 'svg') {
								...
								$w = ($info['w'] / Booknetic_Mpdf::SCALE) * (72 / $this->mpdf->img_dpi);
								$h = ($info['h'] / Booknetic_Mpdf::SCALE) * (72 / $this->mpdf->img_dpi);
							}
						}

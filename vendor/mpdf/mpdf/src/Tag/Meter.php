...
class Meter extends InlineTag
{
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if ($w == 0 && $h == 0) {
			...
			$w = $this->mpdf->FontSize / (10 / Booknetic_Mpdf::SCALE) * abs($info['w']) / Booknetic_Mpdf::SCALE;
			$h = $this->mpdf->FontSize / (10 / Booknetic_Mpdf::SCALE) * abs($info['h']) / Booknetic_Mpdf::SCALE;
		}

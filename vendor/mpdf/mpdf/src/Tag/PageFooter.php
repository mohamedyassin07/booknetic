	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if (isset($attr['HEADER-STYLE']) || isset($attr['FOOTER-STYLE'])) { // font-family,size,weight,style,color
			...
			if (isset($properties['FONT-SIZE'])) {
				$p['L']['font-size'] = $this->sizeConverter->convert($properties['FONT-SIZE']) * Booknetic_Mpdf::SCALE;
				$p['C']['font-size'] = $this->sizeConverter->convert($properties['FONT-SIZE']) * Booknetic_Mpdf::SCALE;
				$p['R']['font-size'] = $this->sizeConverter->convert($properties['FONT-SIZE']) * Booknetic_Mpdf::SCALE;
			}

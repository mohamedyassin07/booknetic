...
class CustomerGroupsApi extends BaseApi
{
     ...
     */
    public function listCustomerGroups($cursor = null)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createCustomerGroup(\Square\Models\CreateCustomerGroupRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/customers/groups';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveCustomerGroup($groupId)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/customers/groups/{group_id}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateCustomerGroup($groupId, \Square\Models\UpdateCustomerGroupRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/customers/groups/{group_id}';

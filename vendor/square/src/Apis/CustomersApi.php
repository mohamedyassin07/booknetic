...
class CustomersApi extends BaseApi
{
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createCustomer(\Square\Models\CreateCustomerRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/customers';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchCustomers(\Square\Models\SearchCustomersRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteCustomer($customerId, $version = null)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateCustomer($customerId, \Square\Models\UpdateCustomerRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/customers/{customer_id}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createCustomerCard($customerId, \Square\Models\CreateCustomerCardRequest $body)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function removeGroupFromCustomer($customerId, $groupId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function addGroupToCustomer($customerId, $groupId)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/customers/{customer_id}/groups/{group_id}';

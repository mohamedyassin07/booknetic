...
class GiftCardsApi extends BaseApi
{
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createGiftCard(\Square\Models\CreateGiftCardRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/gift-cards';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveGiftCardFromGAN(\Square\Models\RetrieveGiftCardFromGANRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveGiftCardFromNonce(\Square\Models\RetrieveGiftCardFromNonceRequest $body)
    {
        //prepare query string for API call

...
class InventoryApi extends BaseApi
{
     ...
     * @deprecated
     *
     * @param $adjustmentId ID of the [InventoryAdjustment]($m/InventoryAdjustment) to
     *                             retrieve.
     *
     ...
     */
    public function deprecatedRetrieveInventoryAdjustment($adjustmentId)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveInventoryAdjustment($adjustmentId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deprecatedBatchChangeInventory(\Square\Models\BatchChangeInventoryRequest $body)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function batchChangeInventory(\Square\Models\BatchChangeInventoryRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function batchRetrieveInventoryCounts(\Square\Models\BatchRetrieveInventoryCountsRequest $body)
    {
        //prepare query string for API call
     ...
     * @deprecated
     *
     * @param $physicalCountId ID of the
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deprecatedRetrieveInventoryPhysicalCount($physicalCountId)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveInventoryPhysicalCount($physicalCountId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveInventoryTransfer($transferId)
    {
        //prepare query string for API call

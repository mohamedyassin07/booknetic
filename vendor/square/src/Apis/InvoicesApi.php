...
class InvoicesApi extends BaseApi
{
     ...
     */
    public function listInvoices($locationId, $cursor = null, $limit = null)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createInvoice(\Square\Models\CreateInvoiceRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/invoices';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchInvoices(\Square\Models\SearchInvoicesRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteInvoice($invoiceId, $version = null)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateInvoice($invoiceId, \Square\Models\UpdateInvoiceRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/invoices/{invoice_id}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function cancelInvoice($invoiceId, \Square\Models\CancelInvoiceRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function publishInvoice($invoiceId, \Square\Models\PublishInvoiceRequest $body)
    {
        //prepare query string for API call

...
class LaborApi extends BaseApi
{
     ...
     */
    public function listBreakTypes($locationId = null, $limit = null, $cursor = null)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createBreakType(\Square\Models\CreateBreakTypeRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/labor/break-types';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateBreakType($id, \Square\Models\UpdateBreakTypeRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/labor/break-types/{id}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createShift(\Square\Models\CreateShiftRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchShifts(\Square\Models\SearchShiftsRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateShift($id, \Square\Models\UpdateShiftRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/labor/shifts/{id}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getTeamMemberWage($id)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateWorkweekConfig($id, \Square\Models\UpdateWorkweekConfigRequest $body)
    {
        //prepare query string for API call

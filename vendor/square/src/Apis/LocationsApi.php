...
class LocationsApi extends BaseApi
{
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createLocation(\Square\Models\CreateLocationRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/locations';
     ...
     * main location.
     *
     * @param $locationId The ID of the location to retrieve. If you specify the string
     *                           "main",
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveLocation($locationId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateLocation($locationId, \Square\Models\UpdateLocationRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/locations/{location_id}';

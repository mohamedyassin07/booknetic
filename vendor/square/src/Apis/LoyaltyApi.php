...
class LoyaltyApi extends BaseApi
{
     ...
     */
    public function createLoyaltyAccount(\Square\Models\CreateLoyaltyAccountRequest $body)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchLoyaltyAccounts(\Square\Models\SearchLoyaltyAccountsRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveLoyaltyAccount($accountId)
    {
        //prepare query string for API call
     ...
     *
     * @param $accountId The [loyalty account]($m/LoyaltyAccount) ID to which to add the
     *                          points.
     ...
     *
     * @param $accountId The ID of the [loyalty account]($m/LoyaltyAccount) in which to
     *                          adjust the points.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function adjustLoyaltyPoints($accountId, \Square\Models\AdjustLoyaltyPointsRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchLoyaltyEvents(\Square\Models\SearchLoyaltyEventsRequest $body)
    {
        //prepare query string for API call
     ...
     * information, see [Loyalty Program Overview](https://developer.squareup.com/docs/loyalty/overview).
     *
     * @param $programId The ID of the loyalty program or the keyword `main`. Either value
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveLoyaltyProgram($programId)
    {
        //prepare query string for API call
     ...
     * com/docs/loyalty-api/overview#loyalty-market-availability).
     *
     * @param $programId The [loyalty program]($m/LoyaltyProgram) ID, which defines the
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createLoyaltyReward(\Square\Models\CreateLoyaltyRewardRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchLoyaltyRewards(\Square\Models\SearchLoyaltyRewardsRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteLoyaltyReward($rewardId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveLoyaltyReward($rewardId)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/loyalty/rewards/{reward_id}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function redeemLoyaltyReward($rewardId, \Square\Models\RedeemLoyaltyRewardRequest $body)
    {
        //prepare query string for API call

...
class OAuthApi extends BaseApi
{
     ...
     * @deprecated
     *
     * @param $clientId Your application ID, available from the [developer dashboard](https:
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function revokeToken(\Square\Models\RevokeTokenRequest $body, $authorization)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function obtainToken(\Square\Models\ObtainTokenRequest $body)
    {
        //prepare query string for API call

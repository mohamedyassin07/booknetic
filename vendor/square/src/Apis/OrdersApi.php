...
class OrdersApi extends BaseApi
{
     ...
     */
    public function createOrder(\Square\Models\CreateOrderRequest $body)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function batchRetrieveOrders(\Square\Models\BatchRetrieveOrdersRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function calculateOrder(\Square\Models\CalculateOrderRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchOrders(\Square\Models\SearchOrdersRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateOrder($orderId, \Square\Models\UpdateOrderRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/orders/{order_id}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function payOrder($orderId, \Square\Models\PayOrderRequest $body)
    {
        //prepare query string for API call

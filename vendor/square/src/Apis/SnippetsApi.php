...
class SnippetsApi extends BaseApi
{
     ...
     */
    public function deleteSnippet($siteId)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveSnippet($siteId)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/sites/{site_id}/snippet';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function upsertSnippet($siteId, \Square\Models\UpsertSnippetRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/sites/{site_id}/snippet';

...
class SubscriptionsApi extends BaseApi
{
     ...
     */
    public function createSubscription(\Square\Models\CreateSubscriptionRequest $body)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchSubscriptions(\Square\Models\SearchSubscriptionsRequest $body)
    {
        //prepare query string for API call

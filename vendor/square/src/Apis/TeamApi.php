...
class TeamApi extends BaseApi
{
     ...
     */
    public function createTeamMember(\Square\Models\CreateTeamMemberRequest $body)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function bulkCreateTeamMembers(\Square\Models\BulkCreateTeamMembersRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function bulkUpdateTeamMembers(\Square\Models\BulkUpdateTeamMembersRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchTeamMembers(\Square\Models\SearchTeamMembersRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveTeamMember($teamMemberId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateTeamMember($teamMemberId, \Square\Models\UpdateTeamMemberRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/team-members/{team_member_id}';
     ...
     *
     * @param $teamMemberId The ID of the team member for which to retrieve the wage
     *                             setting.
     *
     * @return ApiResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveWageSetting($teamMemberId)
    {
        //prepare query string for API call
     ...
     *
     * @param $teamMemberId The ID of the team member for which to update the `WageSetting`
     *                             object.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateWageSetting($teamMemberId, \Square\Models\UpdateWageSettingRequest $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v2/team-members/{team_member_id}/wage-setting';

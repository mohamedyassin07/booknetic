...
class TerminalApi extends BaseApi
{
     ...
     */
    public function createTerminalCheckout(\Square\Models\CreateTerminalCheckoutRequest $body)
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchTerminalCheckouts(\Square\Models\SearchTerminalCheckoutsRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createTerminalRefund(\Square\Models\CreateTerminalRefundRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function searchTerminalRefunds(\Square\Models\SearchTerminalRefundsRequest $body)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getTerminalRefund($terminalRefundId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function cancelTerminalRefund($terminalRefundId)
    {
        //prepare query string for API call

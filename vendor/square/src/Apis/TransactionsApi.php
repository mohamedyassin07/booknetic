...
class TransactionsApi extends BaseApi
{
     ...
     * endpoint's response.
     *
     * Max results per [page](https://developer.squareup.com/docs/working-with-apis/pagination)
     *
     * @deprecated
     *
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function charge($locationId, \Square\Models\ChargeRequest $body)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveTransaction($locationId, $transactionId)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function captureTransaction($locationId, $transactionId)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);
     ...
     * @param $transactionId The ID of the original transaction that includes the tender to
     *                              refund.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function voidTransaction($locationId, $transactionId)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);

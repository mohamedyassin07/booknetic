...
class V1EmployeesApi extends BaseApi
{
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createEmployee(\Square\Models\V1Employee $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v1/me/employees';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveEmployee($employeeId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateEmployee($employeeId, \Square\Models\V1Employee $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v1/me/employees/{employee_id}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createEmployeeRole(\Square\Models\V1EmployeeRole $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v1/me/roles';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveEmployeeRole($roleId)
    {
        //prepare query string for API call
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateEmployeeRole($roleId, \Square\Models\V1EmployeeRole $body)
    {
        //prepare query string for API call
        $_queryBuilder = '/v1/me/roles/{role_id}';

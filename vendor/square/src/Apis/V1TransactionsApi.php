...
class V1TransactionsApi extends BaseApi
{
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveOrder($locationId, $orderId)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);
     ...
     * @deprecated
     *
     * @param $locationId The ID of the location to list payments for. If you specify me,
     ...
     * @param $paymentId The Square-issued payment ID. payment_id comes from Payment
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrievePayment($locationId, $paymentId)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createRefund($locationId, \Square\Models\V1CreateRefundRequest $body)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);
     ...
     * @deprecated
     *
     * @param $locationId The ID of the location to list settlements for. If you specify me,
     ...
     * @param $settlementId The settlement's Square-issued ID. You obtain this value from
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveSettlement($locationId, $settlementId)
    {
        trigger_error('Method ' . __METHOD__ . ' is deprecated.', E_USER_DEPRECATED);

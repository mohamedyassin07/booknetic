...
class BusinessAppointmentSettings implements \JsonSerializable
{
     ...
     */
    public function setLocationTypes(array $locationTypes = null)
    {
     ...
     * @maps alignment_time
     */
    public function setAlignmentTime($alignmentTime = null)
    {
     ...
     */
    public function getMinBookingLeadTimeSeconds()
    {
     ...
     */
    public function setMinBookingLeadTimeSeconds($minBookingLeadTimeSeconds = null)
    {
     ...
     * this far ahead of the booking's starting time.
     */
    public function getMaxBookingLeadTimeSeconds()
    {
     ...
     */
    public function setMaxBookingLeadTimeSeconds($maxBookingLeadTimeSeconds = null)
    {
     ...
     */
    public function getAnyTeamMemberBookingEnabled()
    {
     ...
     */
    public function setAnyTeamMemberBookingEnabled($anyTeamMemberBookingEnabled = null)
    {
     ...
     */
    public function getMultipleServiceBookingEnabled()
    {
     ...
     */
    public function setMultipleServiceBookingEnabled($multipleServiceBookingEnabled = null)
    {
     ...
     */
    public function getMaxAppointmentsPerDayLimitType()
    {
     ...
     */
    public function setMaxAppointmentsPerDayLimitType($maxAppointmentsPerDayLimitType = null)
    {
     ...
     */
    public function getMaxAppointmentsPerDayLimit()
    {
     ...
     */
    public function setMaxAppointmentsPerDayLimit($maxAppointmentsPerDayLimit = null)
    {
     ...
     */
    public function getCancellationWindowSeconds()
    {
     ...
     */
    public function setCancellationWindowSeconds($cancellationWindowSeconds = null)
    {
     ...
     */
    public function getCancellationFeeMoney()
    {
     ...
     */
    public function setCancellationFeeMoney(Money $cancellationFeeMoney = null)
    {
     ...
     */
    public function setCancellationPolicyText($cancellationPolicyText = null)
    {
     ...
     * their choice (`false`).
     */
    public function getSkipBookingFlowStaffSelection()
    {
     ...
     */
    public function setSkipBookingFlowStaffSelection($skipBookingFlowStaffSelection = null)
    {

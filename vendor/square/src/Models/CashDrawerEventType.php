...
class CashDrawerEventType
{
     ...
     */
    const CASH_TENDER_PAYMENT = 'CASH_TENDER_PAYMENT';
     ...
     * A CashDrawerEvent of this type must have a zero money amount.
     */
    const OTHER_TENDER_PAYMENT = 'OTHER_TENDER_PAYMENT';
     ...
     */
    const CASH_TENDER_CANCELLED_PAYMENT = 'CASH_TENDER_CANCELLED_PAYMENT';
     ...
     * amount.
     */
    const OTHER_TENDER_CANCELLED_PAYMENT = 'OTHER_TENDER_CANCELLED_PAYMENT';

    /**
     * Triggered when a cash tender refund occurs.
     * A CashDrawerEvent of this type must not have a negative amount.
     */
    const CASH_TENDER_REFUND = 'CASH_TENDER_REFUND';

    /**
     * Triggered when an other tender refund occurs.
     * A CashDrawerEvent of this type must have a zero money amount.
     */
    const OTHER_TENDER_REFUND = 'OTHER_TENDER_REFUND';

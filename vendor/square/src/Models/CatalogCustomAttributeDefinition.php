...
class CatalogCustomAttributeDefinition implements \JsonSerializable
{
     ...
     */
    public function __construct($type, $name, array $allowedObjectTypes)
    {
        $this->type = $type;
        $this->name = $name;
     ...
     * constraints that the seller should observe, etc. May be displayed as a tooltip in Square UIs.
     */
     ...
     */
    public function setSourceApplication(SourceApplication $sourceApplication = null)
    {
     ...
     * @param string[] $allowedObjectTypes
     */
    public function setAllowedObjectTypes(array $allowedObjectTypes)
    {
        $this->allowedObjectTypes = $allowedObjectTypes;
    }
     ...
     */
    public function setSellerVisibility($sellerVisibility = null)
    {
     ...
     * @maps app_visibility
     */
    public function setAppVisibility($appVisibility = null)
    {
     ...
     * @maps string_config
     */
    public function setStringConfig(CatalogCustomAttributeDefinitionStringConfig $stringConfig = null)
    {
     ...
     * @maps number_config
     */
    public function setNumberConfig(CatalogCustomAttributeDefinitionNumberConfig $numberConfig = null)
    {
     ...
     */
    public function setSelectionConfig(CatalogCustomAttributeDefinitionSelectionConfig $selectionConfig = null)
    {
     ...
     */
    public function setCustomAttributeUsageCount($customAttributeUsageCount = null)
    {

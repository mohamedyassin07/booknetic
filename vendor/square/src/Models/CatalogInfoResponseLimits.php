...
class CatalogInfoResponseLimits implements \JsonSerializable
{
     ...
     */
    public function setBatchUpsertMaxObjectsPerBatch($batchUpsertMaxObjectsPerBatch = null)
    {
     ...
     */
    public function setBatchUpsertMaxTotalObjects($batchUpsertMaxTotalObjects = null)
    {
     ...
     */
    public function setBatchRetrieveMaxObjectIds($batchRetrieveMaxObjectIds = null)
    {
     ...
     */
    public function setSearchMaxPageLimit($searchMaxPageLimit = null)
    {
     ...
     */
    public function setBatchDeleteMaxObjectIds($batchDeleteMaxObjectIds = null)
    {
     ...
     */
    public function setUpdateItemTaxesMaxItemIds($updateItemTaxesMaxItemIds = null)
    {
     ...
     */
    public function setUpdateItemTaxesMaxTaxesToEnable($updateItemTaxesMaxTaxesToEnable = null)
    {
     ...
     */
    public function setUpdateItemTaxesMaxTaxesToDisable($updateItemTaxesMaxTaxesToDisable = null)
    {
     ...
     */
    public function setUpdateItemModifierListsMaxItemIds($updateItemModifierListsMaxItemIds = null)
    {

...
class CatalogItemVariation implements \JsonSerializable
{
     ...
     */
    public function setLocationOverrides(array $locationOverrides = null)
    {
     ...
     */
    public function setTrackInventory($trackInventory = null)
    {
     ...
     */
    public function setInventoryAlertType($inventoryAlertType = null)
    {
     ...
     */
    public function setInventoryAlertThreshold($inventoryAlertThreshold = null)
    {
     ...
     */
    public function getAvailableForBooking()
    {
     ...
     */
    public function setAvailableForBooking($availableForBooking = null)
    {
     ...
     */
    public function setItemOptionValues(array $itemOptionValues = null)
    {
     ...
     * @maps stockable
     */
    public function setStockable($stockable = null)
    {
     ...
     */
    public function setTeamMemberIds(array $teamMemberIds = null)
    {
     ...
     */
    public function getStockableConversion()
    {
     ...
     */
    public function setStockableConversion(CatalogStockConversion $stockableConversion = null)
    {

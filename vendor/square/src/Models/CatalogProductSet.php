...
class CatalogProductSet implements \JsonSerializable
{
     ...
     */
    public function setProductIdsAny(array $productIdsAny = null)
    {
     ...
     */
    public function setProductIdsAll(array $productIdsAll = null)
    {
     ...
     * @maps quantity_exact
     */
    public function setQuantityExact($quantityExact = null)
    {
     ...
     * @maps all_products
     */
    public function setAllProducts($allProducts = null)
    {

...
class CreateCheckoutRequest implements \JsonSerializable
{
     ...
     */
    public function __construct($idempotencyKey, CreateOrderRequest $order)
    {
     ...
     * @maps order
     */
    public function setOrder(CreateOrderRequest $order)
    {
        $this->order = $order;
    }
     ...
     */
    public function setAskForShippingAddress($askForShippingAddress = null)
    {
     ...
     */
    public function setMerchantSupportEmail($merchantSupportEmail = null)
    {
     ...
     */
    public function setPrePopulateBuyerEmail($prePopulateBuyerEmail = null)
    {
     ...
     */
    public function setPrePopulateShippingAddress(Address $prePopulateShippingAddress = null)
    {

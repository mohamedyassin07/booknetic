...
class CustomAttributeFilter implements \JsonSerializable
{
     ...
     * @maps string_filter
     */
    public function setStringFilter($stringFilter = null)
    {
     ...
     * @maps number_filter
     */
    public function setNumberFilter(Range $numberFilter = null)
    {
     ...
     * @return string[]|null
     */
    public function getSelectionUidsFilter()
    {
     ...
     */
    public function setSelectionUidsFilter(array $selectionUidsFilter = null)
    {
     ...
     * @maps bool_filter
     */
    public function setBoolFilter($boolFilter = null)
    {

...
class CustomerFilter implements \JsonSerializable
{
     ...
     */
    public function setCreationSource(CustomerCreationSourceFilter $creationSource = null)
    {
     ...
     * @maps updated_at
     */
    public function setUpdatedAt(TimeRange $updatedAt = null)
    {
     ...
     * @maps email_address
     */
    public function setEmailAddress(CustomerTextFilter $emailAddress = null)
    {
     ...
     * @maps phone_number
     */
    public function setPhoneNumber(CustomerTextFilter $phoneNumber = null)
    {
     ...
     * @maps reference_id
     */
    public function setReferenceId(CustomerTextFilter $referenceId = null)
    {
     ...
     * @maps group_ids
     */
    public function setGroupIds(FilterValue $groupIds = null)
    {

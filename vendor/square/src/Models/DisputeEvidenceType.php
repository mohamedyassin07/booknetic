...
class DisputeEvidenceType
{
     ...
     */
    const GENERIC_EVIDENCE = 'GENERIC_EVIDENCE';
     ...
     * Use when uploading evidence as a file or string.
     */
    const ONLINE_OR_APP_ACCESS_LOG = 'ONLINE_OR_APP_ACCESS_LOG';
     ...
     */
    const AUTHORIZATION_DOCUMENTATION = 'AUTHORIZATION_DOCUMENTATION';
     ...
     * Use when uploading evidence as a file or string.
     */
    const CANCELLATION_OR_REFUND_DOCUMENTATION = 'CANCELLATION_OR_REFUND_DOCUMENTATION';
     ...
     * Use when uploading evidence as a file.
     */
    const CARDHOLDER_COMMUNICATION = 'CARDHOLDER_COMMUNICATION';
     ...
     * Use when uploading evidence as a file or string.
     */
    const CARDHOLDER_INFORMATION = 'CARDHOLDER_INFORMATION';
     ...
     * Use when uploading evidence as a file or string.
     */
    const PURCHASE_ACKNOWLEDGEMENT = 'PURCHASE_ACKNOWLEDGEMENT';
     ...
     * Use when uploading evidence as a file.
     */
    const DUPLICATE_CHARGE_DOCUMENTATION = 'DUPLICATE_CHARGE_DOCUMENTATION';
     ...
     * Use when uploading evidence as a file or string.
     */
    const PRODUCT_OR_SERVICE_DESCRIPTION = 'PRODUCT_OR_SERVICE_DESCRIPTION';
     ...
     * Use when uploading evidence as a file or string.
     */
    const SERVICE_RECEIVED_DOCUMENTATION = 'SERVICE_RECEIVED_DOCUMENTATION';
     ...
     * Use when uploading evidence as a file or string.
     */
    const PROOF_OF_DELIVERY_DOCUMENTATION = 'PROOF_OF_DELIVERY_DOCUMENTATION';
     ...
     * Use when uploading evidence as a file or string.
     */
    const RELATED_TRANSACTION_DOCUMENTATION = 'RELATED_TRANSACTION_DOCUMENTATION';
     ...
     * Use when uploading evidence as a file or string.
     */
    const REBUTTAL_EXPLANATION = 'REBUTTAL_EXPLANATION';

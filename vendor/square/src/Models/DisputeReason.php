...
class DisputeReason
{
     ...
     */
    const AMOUNT_DIFFERS = 'AMOUNT_DIFFERS';
     ...
     */
    const PAID_BY_OTHER_MEANS = 'PAID_BY_OTHER_MEANS';
     ...
     */
    const CUSTOMER_REQUESTS_CREDIT = 'CUSTOMER_REQUESTS_CREDIT';
     ...
     */
    const EMV_LIABILITY_SHIFT = 'EMV_LIABILITY_SHIFT';
}

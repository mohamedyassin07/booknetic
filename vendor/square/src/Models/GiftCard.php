...
class GiftCard implements \JsonSerializable
{
     ...
     * @maps gan_source
     */
    public function setGanSource($ganSource = null)
    {
     ...
     * @maps balance_money
     */
    public function setBalanceMoney(Money $balanceMoney = null)
    {
     ...
     * @maps gan
     */
    public function setGan($gan = null)
    {
        $this->gan = $gan;
    }

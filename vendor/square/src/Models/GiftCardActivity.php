...
class GiftCardActivity implements \JsonSerializable
{
     ...
     * @param $locationId
     */
    public function __construct($type, $locationId)
    {
        $this->type = $type;
     ...
     * @maps gift_card_id
     */
    public function setGiftCardId($giftCardId = null)
    {
     ...
     */
    public function getGiftCardGan()
    {
     ...
     * @maps gift_card_gan
     */
    public function setGiftCardGan($giftCardGan = null)
    {
     ...
     */
    public function getGiftCardBalanceMoney()
    {
     ...
     */
    public function setGiftCardBalanceMoney(Money $giftCardBalanceMoney = null)
    {
     ...
     */
    public function getLoadActivityDetails()
    {
     ...
     */
    public function setLoadActivityDetails(GiftCardActivityLoad $loadActivityDetails = null)
    {
     ...
     */
    public function getActivateActivityDetails()
    {
     ...
     */
    public function setActivateActivityDetails(GiftCardActivityActivate $activateActivityDetails = null)
    {
     ...
     */
    public function getRedeemActivityDetails()
    {
     ...
     */
    public function setRedeemActivityDetails(GiftCardActivityRedeem $redeemActivityDetails = null)
    {
     ...
     */
    public function getClearBalanceActivityDetails()
    {
     ...
     */
    public function setClearBalanceActivityDetails(GiftCardActivityClearBalance $clearBalanceActivityDetails = null)
    {
     ...
     */
    public function getDeactivateActivityDetails()
    {
     ...
     */
    public function setDeactivateActivityDetails(GiftCardActivityDeactivate $deactivateActivityDetails = null)
    {
     ...
     */
    public function getAdjustIncrementActivityDetails()
    {
    ...
    public function setAdjustIncrementActivityDetails(
        GiftCardActivityAdjustIncrement $adjustIncrementActivityDetails = null
    ) {
     ...
     */
    public function getAdjustDecrementActivityDetails()
    {
    ...
    public function setAdjustDecrementActivityDetails(
        GiftCardActivityAdjustDecrement $adjustDecrementActivityDetails = null
    ) {
     ...
     */
    public function getRefundActivityDetails()
    {
     ...
     */
    public function setRefundActivityDetails(GiftCardActivityRefund $refundActivityDetails = null)
    {
     ...
     */
    public function getUnlinkedActivityRefundActivityDetails()
    {
    ...
    public function setUnlinkedActivityRefundActivityDetails(
        GiftCardActivityUnlinkedActivityRefund $unlinkedActivityRefundActivityDetails = null
    ) {
     ...
     */
    public function getImportActivityDetails()
    {
     ...
     */
    public function setImportActivityDetails(GiftCardActivityImport $importActivityDetails = null)
    {
     ...
     */
    public function getBlockActivityDetails()
    {
     ...
     */
    public function setBlockActivityDetails(GiftCardActivityBlock $blockActivityDetails = null)
    {
     ...
     */
    public function getUnblockActivityDetails()
    {
     ...
     */
    public function setUnblockActivityDetails(GiftCardActivityUnblock $unblockActivityDetails = null)
    {
     ...
     */
    public function getImportReversalActivityDetails()
    {
    ...
    public function setImportReversalActivityDetails(
        GiftCardActivityImportReversal $importReversalActivityDetails = null
    ) {

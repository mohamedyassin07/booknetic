...
class GiftCardActivityLoad implements \JsonSerializable
{
     ...
     */
    public function getLineItemUid()
    {
     ...
     * @maps line_item_uid
     */
    public function setLineItemUid($lineItemUid = null)
    {
     ...
     * @return string[]|null
     */
    public function getBuyerPaymentInstrumentIds()
    {
     ...
     */
    public function setBuyerPaymentInstrumentIds(array $buyerPaymentInstrumentIds = null)
    {

...
class GiftCardActivityRefund implements \JsonSerializable
{
    ...
    /**
     * @param $redeemActivityId
     */
    public function __construct($redeemActivityId)
    {
     ...
     */
    public function getRedeemActivityId()
    {
     ...
     */
    public function setRedeemActivityId($redeemActivityId)
    {
        $this->redeemActivityId = $redeemActivityId;
    }

...
class InvoicePaymentRequest implements \JsonSerializable
{
     ...
     * for more information.
     */
    public function getFixedAmountRequestedMoney()
    {
     ...
     */
    public function setFixedAmountRequestedMoney(Money $fixedAmountRequestedMoney = null)
    {
     ...
     */
    public function getPercentageRequested()
    {
     ...
     */
    public function setPercentageRequested($percentageRequested = null)
    {
     ...
     */
    public function getTippingEnabled()
    {
     ...
     */
    public function setTippingEnabled($tippingEnabled = null)
    {
     ...
     */
    public function getAutomaticPaymentSource()
    {
     ...
     */
    public function setAutomaticPaymentSource($automaticPaymentSource = null)
    {
     ...
     */
    public function setReminders(array $reminders = null)
    {
     ...
     * for more information.
     */
    public function getComputedAmountMoney()
    {
     ...
     */
    public function setComputedAmountMoney(Money $computedAmountMoney = null)
    {
     ...
     * for more information.
     */
    public function getTotalCompletedAmountMoney()
    {
     ...
     */
    public function setTotalCompletedAmountMoney(Money $totalCompletedAmountMoney = null)
    {
     ...
     * for more information.
     */
    public function getRoundingAdjustmentIncludedMoney()
    {
     ...
     */
    public function setRoundingAdjustmentIncludedMoney(Money $roundingAdjustmentIncludedMoney = null)
    {

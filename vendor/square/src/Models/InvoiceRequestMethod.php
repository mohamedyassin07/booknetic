...
class InvoiceRequestMethod
{
     ...
     */
    const CHARGE_CARD_ON_FILE = 'CHARGE_CARD_ON_FILE';
     ...
     */
    const SHARE_MANUALLY = 'SHARE_MANUALLY';
     ...
     */
    const CHARGE_BANK_ON_FILE = 'CHARGE_BANK_ON_FILE';
     ...
     */
    const SMS_CHARGE_CARD_ON_FILE = 'SMS_CHARGE_CARD_ON_FILE';
     ...
     */
    const SMS_CHARGE_BANK_ON_FILE = 'SMS_CHARGE_BANK_ON_FILE';
}

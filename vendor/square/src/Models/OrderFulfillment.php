...
class OrderFulfillment implements \JsonSerializable
{
     ...
     * @maps pickup_details
     */
    public function setPickupDetails(OrderFulfillmentPickupDetails $pickupDetails = null)
    {
     ...
     */
    public function setShipmentDetails(OrderFulfillmentShipmentDetails $shipmentDetails = null)
    {

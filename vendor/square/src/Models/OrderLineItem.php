...
class OrderLineItem implements \JsonSerializable
{
     ...
     */
    public function setGrossSalesMoney(Money $grossSalesMoney = null)
    {
     ...
     * discounts).
     */
    public function getPricingBlocklists()
    {
     ...
     */
    public function setPricingBlocklists(OrderLineItemPricingBlocklists $pricingBlocklists = null)
    {

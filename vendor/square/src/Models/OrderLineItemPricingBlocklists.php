...
class OrderLineItemPricingBlocklists implements \JsonSerializable
{
     ...
     */
    public function getBlockedDiscounts()
    {
     ...
     */
    public function setBlockedDiscounts(array $blockedDiscounts = null)
    {
     ...
     */
    public function getBlockedTaxes()
    {
     ...
     */
    public function setBlockedTaxes(array $blockedTaxes = null)
    {

...
class OrderLineItemPricingBlocklistsBlockedDiscount implements \JsonSerializable
{
     ...
     * @maps discount_uid
     */
    public function setDiscountUid($discountUid = null)
    {
     ...
     * `discount_uid` field.
     */
    public function getDiscountCatalogObjectId()
    {
     ...
     */
    public function setDiscountCatalogObjectId($discountCatalogObjectId = null)
    {

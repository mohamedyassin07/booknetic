...
class SearchCatalogObjectsRequest implements \JsonSerializable
{
     ...
     */
    public function setObjectTypes(array $objectTypes = null)
    {
     ...
     */
    public function setIncludeDeletedObjects($includeDeletedObjects = null)
    {
     ...
     */
    public function setIncludeRelatedObjects($includeRelatedObjects = null)
    {
     ...
     * @maps query
     */
    public function setQuery(CatalogQuery $query = null)
    {
        $this->query = $query;
    }

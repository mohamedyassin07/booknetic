...
class SegmentFilter implements \JsonSerializable
{
     ...
     */
    public function __construct($serviceVariationId)
    {
     ...
     */
    public function getTeamMemberIdFilter()
    {
     ...
     */
    public function setTeamMemberIdFilter(FilterValue $teamMemberIdFilter = null)
    {

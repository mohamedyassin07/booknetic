...
class TaxIds implements \JsonSerializable
{
     ...
     * @maps eu_vat
     */
    public function setEuVat($euVat = null)
    {
        $this->euVat = $euVat;
    }
     ...
     * @maps fr_siret
     */
    public function setFrSiret($frSiret = null)
    {
     ...
     * @maps fr_naf
     */
    public function setFrNaf($frNaf = null)
    {
        $this->frNaf = $frNaf;
    }

...
class TipSettings implements \JsonSerializable
{
     ...
     * @maps allow_tipping
     */
    public function setAllowTipping($allowTipping = null)
    {
     ...
     */
    public function setSeparateTipScreen($separateTipScreen = null)
    {
     ...
     */
    public function setCustomTipField($customTipField = null)
    {
     ...
     * @return int[]|null
     */
    public function getTipPercentages()
    {
     ...
     */
    public function setTipPercentages(array $tipPercentages = null)
    {
     ...
     */
    public function getSmartTipping()
    {
     ...
     * @maps smart_tipping
     */
    public function setSmartTipping($smartTipping = null)
    {

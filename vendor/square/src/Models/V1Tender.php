...
class V1Tender implements \JsonSerializable
{
     ...
     * @maps pan_suffix
     */
    public function setPanSuffix($panSuffix = null)
    {
     ...
     * @maps tendered_money
     */
    public function setTenderedMoney(V1Money $tenderedMoney = null)
    {
     ...
     * @maps tendered_at
     */
    public function setTenderedAt($tenderedAt = null)
    {
     ...
     * @maps settled_at
     */
    public function setSettledAt($settledAt = null)
    {
     ...
     */
    public function setChangeBackMoney(V1Money $changeBackMoney = null)
    {
